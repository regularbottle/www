...
To submit a vulnerability report, please contact us at <security@ramsey.dev>. Your submission will be reviewed and
...
"authorized" conduct and will not pursue civil action or initiate a complaint to law enforcement. We will help to the
extent we can if legal action is initiated by a third party against you.
...
For increased privacy when reporting sensitive issues, you may encrypt your messages using the following key:
